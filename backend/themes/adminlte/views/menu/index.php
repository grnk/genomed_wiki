...
<div class="sortable-section connectedSortable" data-item-id="0">
    ...
    <div class="item" data-id="1" data-order="1" data-parent-id="0">
        <div class="item-header">Раздел 1</div>
        <div class="item-body">
            <div class="sortable-section connectedSortable" data-item-id="1">
                <div class="item" data-id="2" data-order="1" data-parent-id="1">
                    <div class="item-header">Подраздел 1.1</div>
                    <div class="item-body">
                        <div class="sortable-section connectedSortable" data-item-id="2">
                        </div>
                    </div>
                </div>
                <div class="item" data-id="3" data-order="2" data-parent-id="1">
                    ...
                    <div class="item-body">
                        <div class="sortable-section connectedSortable" data-item-id="3">
                        </div>
                    </div>
                </div>
            </div>
